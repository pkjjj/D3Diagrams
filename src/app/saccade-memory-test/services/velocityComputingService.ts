...
import { LAST_STAGE_WITHOUT_GREEN_POINT } from '../constants/movement-chart';
import { IPoint } from '../constants/types';
import { TRESHOLD_VELOCITY } from '../constants/velocity-chart';
...
export class VelocityComputingService {
    ...
    public computeVelocityDataByFramesCount(frames: ICamMessage[]): IChartData {
    ...
    private tuneFrames(frames: ICamMessage[]) {
        frames.forEach((frame, index) => {
